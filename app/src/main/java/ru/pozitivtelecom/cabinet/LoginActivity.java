...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginView = (AutoCompleteTextView) findViewById(R.id.txt_login);
        ...
        Button mLoginSignInButton = (Button) findViewById(R.id.btn_login);
        ...
        //Hide soft keyboard
        LinearLayout mRootLinearLayout = (LinearLayout)findViewById(R.id.linlayout_root);
        mRootLinearLayout.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                //hideSoftKeyboard(view);
            }
